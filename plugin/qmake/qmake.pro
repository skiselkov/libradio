...
DEFINES += XPLM200 XPLM210 XPLM300 XPLM301 XPLM310

DEFINES += LIBRADIO_APCTL=$$[LIBRADIO_APCTL]
DEFINES += LIBRADIO_OPENGPWS_CTL=$$[LIBRADIO_OPENGPWS_CTL]
DEFINES += LIBRADIO_DEF_CLAMP=$$[LIBRADIO_DEF_CLAMP]

BACKEND += $$[LIBRADIO_BACKEND]
contains(BACKEND, 1) {
	DEFINES += LIBRADIO_BACKEND
}
...
HEADERS += ../../src/*.h ../../src/libradio/*.h
SOURCES += ../../src/*.c ../../src/*.cc ../*.c
